...
if (isset($_POST['login'])) {
    ...
    if ($user = mysqli_fetch_assoc($result)) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $stuSql = "SELECT * FROM students WHERE user_id = $user_id";
            $stuResult = mysqli_query($conn, $stuSql);
            $student = mysqli_fetch_assoc($stuResult);
        ...
        echo "<script>alert('Email not found or not a student account');</script>";
    }
}
?>
...
<title>HireHub - Student Login</title>
